...
namespace mv
{
    struct Image
    {
        ...
        Image(void) {}
        ~Image() {} // image is cleaned up in engine
        ...
        void create(std::weak_ptr<mv::Device> mv_device,
                    ...
                    std::string image_filename)
        {
            ...
            alloc_info.memoryTypeIndex = m_dvc->get_memory_type(memory_requirements.memoryTypeBits,
            ...
            // create image view
            image_view = std::make_unique<vk::ImageView>(m_dvc->logical_device->createImageView(view_info));
        ...
        void create_staging_buffer(vk::DeviceSize &size,
                                   vk::Buffer &staging_buffer,
                                   vk::DeviceMemory &staging_memory)
        {
            auto m_dvc = mv_device.lock();
            ...
            alloc_info.memoryTypeIndex = m_dvc->get_memory_type(staging_req.memoryTypeBits,
        ...
        vk::CommandBuffer begin_command_buffer(void)
        {
            ...
            std::vector<vk::CommandBuffer> cmd_buffers = m_dvc->logical_device->allocateCommandBuffers(alloc_info);
