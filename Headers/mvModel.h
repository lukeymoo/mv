...
public:
  ...
  inline void
  move (float p_OrbitAngle, glm::vec4 p_UnitVectorAxis)
  {
  ...
  inline glm::vec3
  rotateVector (float p_OrbitAngle, glm::vec4 p_TargetAxii)
  {
...
struct Vertex
{
  ...
  // }
  // template <typename T>
  // Vertex (std::initializer_list<T> p_Position,
...
public:
  ...
  std::vector<Texture> loadMaterialTextures (Engine *p_Engine,
