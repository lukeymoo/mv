...
class Model
{
  public:
    ...
    void load(Engine *p_Engine, Allocator &p_DescriptorAllocator, const char *p_Filename, bool p_OutputDebug = true);
    ...
    std::vector<Texture> loadMaterialTextures(Engine *p_Engine, aiMaterial *p_Material, aiTextureType p_Type,
