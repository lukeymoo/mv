...
private:
  ...
  struct MapModal
  {
    ...
    struct CameraItem
    {
      ...
      std::unordered_map<CameraItem::Type, std::pair<std::string, bool>>
          typeMap = {
  ...
  struct FileSystem
  {
    ...
    listDirectory (std::filesystem::path p_Path);
  } fileSystem;
                ...
                if (p_ListType == ListType::eHeightMaps)
                  {
                    ...
                    std::cout << "Called load heightmap\n";
                  }
  ...
  void (*showOpenDialog) (GuiHandler *p_This) = [] (GuiHandler *p_This) {
    ...
    if (ImGui::BeginPopupModal ("Load map file...",
                                ...
                                p_This->fileMenu.openModal.flags))
      {
        ...
        std::vector<std::pair<int, std::string>> directoryButtons
            = p_This->splitPath (
                p_This->fileSystem.currentDirectory.string ());
  ...
  */
  ...
  void (*selectNewTerrainFile) (GuiHandler *p_This) = [] (GuiHandler *p_This) {
    ...
    if (ImGui::BeginPopupModal (
            "Select terrain file", &p_This->mapModal.selectTerrainModal.isOpen,
