...
// Data
enum XlibClientApi { GlfwClientApi_Unknown, GlfwClientApi_OpenGL, GlfwClientApi_Vulkan };
static Xlibwindow *g_Window = NULL; // Main window
static XlibClientApi g_ClientApi = GlfwClientApi_Unknown;
static double g_Time = 0.0;
static bool g_MouseJustPressed[ImGuiMouseButton_COUNT] = {};
static Xlibcursor *g_MouseCursors[ImGuiMouseCursor_COUNT] = {};
static bool g_InstalledCallbacks = false;

// Chain GLFW callbacks: our callbacks will call the user's previously installed callbacks, if any.
static Xlibmousebuttonfun g_PrevUserCallbackMousebutton = NULL;
static Xlibscrollfun g_PrevUserCallbackScroll = NULL;
static Xlibkeyfun g_PrevUserCallbackKey = NULL;
static Xlibcharfun g_PrevUserCallbackChar = NULL;
...
void ImGui_ImplXlib_MouseButtonCallback(Xlibwindow *window, int button, int action, int mods) {
...
void ImGui_ImplXlib_ScrollCallback(Xlibwindow *window, double xoffset, double yoffset) {
...
void ImGui_ImplXlib_KeyCallback(Xlibwindow *window, int key, int scancode, int action, int mods) {
...
void ImGui_ImplXlib_CharCallback(Xlibwindow *window, unsigned int c) {
...
static bool ImGui_ImplXlib_Init(Xlibwindow *window, bool install_callbacks,
                                XlibClientApi client_api) {
  g_Window = window;
  g_Time = 0.0;
