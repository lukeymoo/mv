...
// Missing features:
//  [ ] Renderer: User texture binding. Changes of ImTextureID aren't supported by this backend! See
                                              ...
                                              int fb_width, int fb_height)
{
    // Bind pipeline and descriptor sets:
    {
        ...
        vkCmdBindDescriptorSets(command_buffer, VK_PIPELINE_BIND_POINT_GRAPHICS, g_PipelineLayout, 0, 1, desc_set, 0,
                                NULL);
    }
...
bool ImGui_ImplVulkan_CreateDeviceObjects()
{
    ...
    ImGui_ImplVulkan_CreatePipeline(v->Device, v->Allocator, v->PipelineCache, g_RenderPass, v->MSAASamples,
                                    &g_Pipeline, g_Subpass);
