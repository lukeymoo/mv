  ...
  */
  ...
  public:
    Camera(struct camera_init_struct &init_params) {
      ...
      memcpy(projection_uniform_object->mv_buffer.mapped, &projection_uniform_object->matrix,
  ...
  public:
    enum camera_type { free_look = 0, first_person, third_person };
    float pitch = 40.0f;
  ...
  public:
    ...
    inline void update(void) {
      ...
      memcpy(view_uniform_object->mv_buffer.mapped, &view_uniform_object->matrix,
             sizeof(view_uniform_object->matrix));
      return;
    }
    ...
    inline void update_third_person(void) {
      ...
      glm::mat4 y_mat =
          glm::rotate(glm::mat4(1.0f), glm::radians(orbit_angle), glm::vec3(0.0f, 1.0f, 0.0f));
